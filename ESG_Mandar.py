...
try:
    ...
    pd_selected_df = pd_selected_df.groupby('CSRHUB_ID','COMPANY_NAME','ISIN','TICKER','INDUSTRY_DESC','DJ30TAG','COMMUNITY','EMPLOYEES','ENVIRONMENT','GOVERNANCE','RATING_STATUS')[['RATING_DATE']].max()
    st.write("")
    st.write("")
